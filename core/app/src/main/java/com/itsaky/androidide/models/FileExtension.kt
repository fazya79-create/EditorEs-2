...
enum class FileExtension(val extension: String, @DrawableRes val icon: Int) {
  ...
  CC("cc", R.drawable.ic_language_cpp),
  CXX("cxx", R.drawable.ic_language_cpp),
  C("c", R.drawable.ic_language_cpp),
  H("h", R.drawable.ic_language_cpp),
  HPP("hpp", R.drawable.ic_language_cpp),
  HH("hh", R.drawable.ic_language_cpp),
  HXX("hxx", R.drawable.ic_language_cpp),
